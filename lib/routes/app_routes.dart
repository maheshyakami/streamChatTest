...
import 'package:stream/screens/chat_info_screen.dart';
import 'package:stream/screens/choose_user_page.dart';
import 'package:stream/screens/group_chat_details_screen.dart';
import 'package:stream/screens/group_info_screen.dart';
import 'package:stream/screens/login_page.dart';
import 'package:stream/screens/new_group_chat_screen.dart';
  ...
  static Route<dynamic>? generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case Routes.LOGIN_PAGE:
        return MaterialPageRoute(
          settings: const RouteSettings(name: Routes.LOGIN_PAGE),
          builder: (_) => LoginPage(),
        );
